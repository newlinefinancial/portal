Application.$controller("ParcelTrackingPageController", ["$scope", function($scope) {
    "use strict";
    ...
    $scope.onPageReady = function() {
        ...
        function initMap() {
            ...
            map.addListener('click', function(event) {
                ...
                // close existing infoWindow, if present - uncomment the lines below to activate this functionality
                // if (infoWindow !== null) {
                //     infoWindow.close();
                // }
