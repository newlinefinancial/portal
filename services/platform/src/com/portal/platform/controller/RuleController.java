 ...
 * @see Rule
 */
@RestController("platform.RuleController")
...
public class RuleController {
    ...
    /**
     * @deprecated Use {@link #findRules(String)} instead.
     */
    @Deprecated
    ...
    @ApiOperation(value = "Returns the list of Rule instances matching the search criteria.")
    public Page<Rule> findRules(@RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Rules list");
        return ruleService.findAll(query, pageable);
    }

    @RequestMapping(value = "/export/{exportType}", method = RequestMethod.GET, produces = "application/octet-stream")
    @ApiOperation(value = "Returns downloadable file for the data.")
    public Downloadable exportRules(@PathVariable("exportType") ExportType exportType, @RequestParam(value = "q", required = false) String query, Pageable pageable) {
	 ...
	 *
	 * @param service RuleService instance
	 */
    ...
    public Rule getRule(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        ...
        LOGGER.debug("Rule details with id: {}", foundRule);
        return foundRule;
    }
}
