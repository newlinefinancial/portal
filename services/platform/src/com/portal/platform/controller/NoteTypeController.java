 ...
 * @see NoteType
 */
@RestController("platform.NoteTypeController")
...
public class NoteTypeController {
    ...
    /**
     * @deprecated Use {@link #findNoteTypes(String)} instead.
     */
    @Deprecated
    ...
    @ApiOperation(value = "Returns the list of NoteType instances matching the search criteria.")
    public Page<NoteType> findNoteTypes(@RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering NoteTypes list");
        return noteTypeService.findAll(query, pageable);
    }

    @RequestMapping(value = "/export/{exportType}", method = RequestMethod.GET, produces = "application/octet-stream")
    @ApiOperation(value = "Returns downloadable file for the data.")
    public Downloadable exportNoteTypes(@PathVariable("exportType") ExportType exportType, @RequestParam(value = "q", required = false) String query, Pageable pageable) {
	 ...
	 *
	 * @param service NoteTypeService instance
	 */
    ...
    public NoteType getNoteType(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        ...
        NoteType foundNoteType = noteTypeService.getById(id);
        LOGGER.debug("NoteType details with id: {}", foundNoteType);
