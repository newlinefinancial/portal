 ...
 * @see TitleTransaction
 */
@RestController("platform.TitleTransactionController")
...
public class TitleTransactionController {
    ...
    /**
     * @deprecated Use {@link #findTitleTransactions(String)} instead.
     */
    @Deprecated
    ...
    @ApiOperation(value = "Returns the list of TitleTransaction instances matching the search criteria.")
    public Page<TitleTransaction> findTitleTransactions(@RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TitleTransactions list");
        return titleTransactionService.findAll(query, pageable);
    }

    @RequestMapping(value = "/export/{exportType}", method = RequestMethod.GET, produces = "application/octet-stream")
    @ApiOperation(value = "Returns downloadable file for the data.")
    public Downloadable exportTitleTransactions(@PathVariable("exportType") ExportType exportType, @RequestParam(value = "q", required = false) String query, Pageable pageable) {
    ...
    public TitleTransaction getTitleTransaction(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        ...
        TitleTransaction foundTitleTransaction = titleTransactionService.getById(id);
        LOGGER.debug("TitleTransaction details with id: {}", foundTitleTransaction);
        return foundTitleTransaction;
    }
}
