...
@Api(description = "Exposes APIs to work with BankReportHistory resource.", value = "BankReportHistoryController")
public class BankReportHistoryController {
    ...
    public BankReportHistory getBankReportHistory(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
