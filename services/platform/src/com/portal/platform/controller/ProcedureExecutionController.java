...
@RestController(value = "Platform.ProcedureExecutionController")
@RequestMapping("/platform/procedureExecutor")
...
public class ProcedureExecutionController {
    ...
    @Autowired
    private PlatformProcedureExecutorService procedureService;
