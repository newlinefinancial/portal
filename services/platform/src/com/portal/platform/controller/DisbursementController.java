 ...
 */
@RestController(value = "Platform.DisbursementController")
...
public class DisbursementController {
    ...
    @ApiOperation(value = "Returns the list of Disbursement instances.")
    public Page<Disbursement> getDisbursements(Pageable pageable) {
        LOGGER.debug("Rendering Disbursements list");
        return disbursementService.findAll(pageable);
    }
    ...
    @ApiOperation(value = "Creates a new Disbursement instance.")
    public Disbursement createDisbursement(@RequestBody Disbursement instance) {
        LOGGER.debug("Create Disbursement with information: {}", instance);
        instance = disbursementService.create(instance);
        LOGGER.debug("Created Disbursement with information: {}", instance);
        return instance;
    }
    ...
    public Long countAllDisbursements() {
        ...
        Long count = disbursementService.countAll();
        return count;
    }
    ...
    public Disbursement getDisbursement(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        ...
        Disbursement instance = disbursementService.findById(id);
        LOGGER.debug("Disbursement details with id: {}", instance);
        return instance;
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Updates the Disbursement instance associated with the given id.")
    public Disbursement editDisbursement(@PathVariable(value = "id") Integer id, @RequestBody Disbursement instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Disbursement with id: {}", instance.getId());
        instance.setId(id);
        instance = disbursementService.update(instance);
        LOGGER.debug("Disbursement details with id: {}", instance);
        return instance;
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Deletes the Disbursement instance associated with the given id.")
    public boolean deleteDisbursement(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Deleting Disbursement with id: {}", id);
        Disbursement deleted = disbursementService.delete(id);
        return deleted != null;
    }
}
