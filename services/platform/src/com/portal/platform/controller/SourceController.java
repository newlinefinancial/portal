 ...
 */
@RestController(value = "Platform.SourceController")
...
public class SourceController {
    ...
    @ApiOperation(value = "Returns the list of Source instances.")
    ...
    public Source createSource(@RequestBody Source instance) {
        LOGGER.debug("Create Source with information: {}", instance);
        instance = sourceService.create(instance);
        LOGGER.debug("Created Source with information: {}", instance);
        return instance;
    }
    ...
    public Long countAllSources() {
        ...
        Long count = sourceService.countAll();
        return count;
    }
    ...
    public Source getSource(@PathVariable(value = "id") String id) throws EntityNotFoundException {
        ...
        Source instance = sourceService.findById(id);
        LOGGER.debug("Source details with id: {}", instance);
        return instance;
    }
    ...
    public Source editSource(@PathVariable(value = "id") String id, @RequestBody Source instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Source with id: {}", instance.getCode());
        instance.setCode(id);
        instance = sourceService.update(instance);
        LOGGER.debug("Source details with id: {}", instance);
        return instance;
    }
    ...
    public boolean deleteSource(@PathVariable(value = "id") String id) throws EntityNotFoundException {
        LOGGER.debug("Deleting Source with id: {}", id);
        Source deleted = sourceService.delete(id);
        return deleted != null;
    }
}
