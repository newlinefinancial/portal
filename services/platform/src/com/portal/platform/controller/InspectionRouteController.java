 ...
 * @see InspectionRoute
 */
@RestController("platform.InspectionRouteController")
...
public class InspectionRouteController {
    ...
    /**
     * @deprecated Use {@link #findInspectionRoutes(String)} instead.
     */
    @Deprecated
    ...
    @ApiOperation(value = "Returns the list of InspectionRoute instances matching the search criteria.")
    public Page<InspectionRoute> findInspectionRoutes(@RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering InspectionRoutes list");
        return inspectionRouteService.findAll(query, pageable);
    }

    @RequestMapping(value = "/export/{exportType}", method = RequestMethod.GET, produces = "application/octet-stream")
    @ApiOperation(value = "Returns downloadable file for the data.")
    public Downloadable exportInspectionRoutes(@PathVariable("exportType") ExportType exportType, @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        return inspectionRouteService.export(exportType, query, pageable);
    }
    ...
    public Long countInspectionRoutes(@RequestParam(value = "q", required = false) String query) {
        LOGGER.debug("counting InspectionRoutes");
        return inspectionRouteService.count(query);
    }
    ...
    public InspectionRoute getInspectionRoute(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        ...
        InspectionRoute foundInspectionRoute = inspectionRouteService.getById(id);
        LOGGER.debug("InspectionRoute details with id: {}", foundInspectionRoute);
        return foundInspectionRoute;
    }
}
