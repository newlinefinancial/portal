...
@Api(description = "Exposes APIs to work with BidFile resource.", value = "BidFileController")
public class BidFileController {
    ...
    public BidFile getBidFile(@RequestParam(value = "auctionId", required = true) int auctionId, @RequestParam(value = "taxYear", required = true) int taxYear, @RequestParam(value = "auctionDay", required = true) Integer auctionDay, @RequestParam(value = "advNumber", required = true) Integer advNumber, @RequestParam(value = "pinNumber", required = true) String pinNumber, @RequestParam(value = "bid", required = true) Integer bid) throws EntityNotFoundException {
