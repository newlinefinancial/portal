...
import com.portal.platform.PropertyType;
 ...
 * @see PropertyType
 */
@RestController("platform.PropertyTypeController")
...
public class PropertyTypeController {
    ...
    /**
     * @deprecated Use {@link #findPropertyTypes(String)} instead.
     */
    @Deprecated
    ...
    @ApiOperation(value = "Returns the list of PropertyType instances matching the search criteria.")
    public Page<PropertyType> findPropertyTypes(@RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering PropertyTypes list");
        return propertyTypeService.findAll(query, pageable);
    }

    @RequestMapping(value = "/export/{exportType}", method = RequestMethod.GET, produces = "application/octet-stream")
    @ApiOperation(value = "Returns downloadable file for the data.")
    public Downloadable exportPropertyTypes(@PathVariable("exportType") ExportType exportType, @RequestParam(value = "q", required = false) String query, Pageable pageable) {
	 ...
	 *
	 * @param service PropertyTypeService instance
	 */
    ...
    public PropertyType getPropertyType(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        ...
        PropertyType foundPropertyType = propertyTypeService.getById(id);
        LOGGER.debug("PropertyType details with id: {}", foundPropertyType);
