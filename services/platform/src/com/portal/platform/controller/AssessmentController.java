 ...
 */
@RestController(value = "Platform.AssessmentController")
...
public class AssessmentController {
    ...
    public Assessment editAssessment(@PathVariable(value = "id") Integer id, @RequestBody Assessment instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Assessment with id: {}", instance.getId());
        instance.setId(id);
