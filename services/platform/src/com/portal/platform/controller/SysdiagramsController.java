...
@Api(value = "/platform/Sysdiagrams", description = "Exposes APIs to work with Sysdiagrams resource.")
...
public class SysdiagramsController {
    ...
    public Sysdiagrams editSysdiagrams(@PathVariable("id") Integer id, @RequestBody Sysdiagrams sysdiagrams) throws EntityNotFoundException {
