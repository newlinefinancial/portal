...
@Api(value = "/platform/Date", description = "Exposes APIs to work with Date resource.")
...
public class DateController {
    ...
    public Date getDate(@PathVariable("id") java.util.Date id) throws EntityNotFoundException {
    ...
    public Date editDate(@PathVariable("id") java.util.Date id, @RequestBody Date dateInstance) throws EntityNotFoundException {
    ...
    public boolean deleteDate(@PathVariable("id") java.util.Date id) throws EntityNotFoundException {
