...
public class AvailableSubsController {
    ...
    /**
     * @deprecated Use {@link #findAvailableSubs(String)} instead.
     */
    @Deprecated
    @RequestMapping(value = "/search", method = RequestMethod.POST)
    @ApiOperation(value = "Returns the list of AvailableSubs instances matching the search criteria.")
    public Page<AvailableSubs> findAvailableSubs(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
    ...
    @ApiOperation(value = "Returns the list of AvailableSubs instances matching the search criteria.")
    public Page<AvailableSubs> findAvailableSubs(@RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering AvailableSubs list");
    ...
    public Downloadable exportAvailableSubs(@PathVariable("exportType") ExportType exportType, @RequestParam(value = "q", required = false) String query, Pageable pageable) {
