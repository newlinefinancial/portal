 ...
 * @see TaxSchedule
 */
@RestController("platform.TaxScheduleController")
...
public class TaxScheduleController {
    ...
    /**
     * @deprecated Use {@link #findTaxSchedules(String)} instead.
     */
    @Deprecated
    ...
    @ApiOperation(value = "Returns the list of TaxSchedule instances matching the search criteria.")
    public Page<TaxSchedule> findTaxSchedules(@RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TaxSchedules list");
        return taxScheduleService.findAll(query, pageable);
    }

    @RequestMapping(value = "/export/{exportType}", method = RequestMethod.GET, produces = "application/octet-stream")
    @ApiOperation(value = "Returns downloadable file for the data.")
    public Downloadable exportTaxSchedules(@PathVariable("exportType") ExportType exportType, @RequestParam(value = "q", required = false) String query, Pageable pageable) {
    ...
    public TaxSchedule getTaxSchedule(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        ...
        TaxSchedule foundTaxSchedule = taxScheduleService.getById(id);
        LOGGER.debug("TaxSchedule details with id: {}", foundTaxSchedule);
        return foundTaxSchedule;
    }
}
