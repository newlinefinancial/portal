 ...
 */
@RestController(value = "Platform.AuctionController")
...
public class AuctionController {
    ...
    @ApiOperation(value = "Returns the list of Auction instances.")
    ...
    @ApiOperation(value = "Creates a new Auction instance.")
    public Auction createAuction(@RequestBody Auction instance) {
        LOGGER.debug("Create Auction with information: {}", instance);
        instance = auctionService.create(instance);
        LOGGER.debug("Created Auction with information: {}", instance);
        return instance;
    }
    ...
    public Long countAllAuctions() {
        ...
        Long count = auctionService.countAll();
        return count;
    }
    ...
    public Auction getAuction(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        ...
        Auction instance = auctionService.findById(id);
        LOGGER.debug("Auction details with id: {}", instance);
        return instance;
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Updates the Auction instance associated with the given id.")
    public Auction editAuction(@PathVariable(value = "id") Integer id, @RequestBody Auction instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Auction with id: {}", instance.getId());
        instance.setId(id);
        instance = auctionService.update(instance);
        LOGGER.debug("Auction details with id: {}", instance);
        return instance;
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Deletes the Auction instance associated with the given id.")
    public boolean deleteAuction(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Deleting Auction with id: {}", id);
        Auction deleted = auctionService.delete(id);
        return deleted != null;
    }
}
