...
@Api(value = "/platform/CertificateParty", description = "Exposes APIs to work with CertificateParty resource.")
...
public class CertificatePartyController {
    ...
    public CertificateParty getCertificateParty(@PathVariable("id") Integer id) throws EntityNotFoundException {
