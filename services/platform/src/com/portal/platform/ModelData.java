...
/**
 * ModelData generated by hbm2java
 */
@Entity
@Table(name="`model_data`"
    ,schema="review"
)
@IdClass(value=ModelDataId.class)
public class ModelData  implements java.io.Serializable {
    ...
    @Column(name="`months_delinquent`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`prior_years_due`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`other_due`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`auction_year_due`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`total_amt_due`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`annual_tax_amt`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`ini_sub_status`", insertable=false, updatable=false, length=7)
    ...
    @Column(name="`ini_sub_pct`", insertable=false, updatable=false, precision=53, scale=9)
    ...
    @Column(name="`ltv`", insertable=false, updatable=false, precision=53, scale=9)
    ...
    @Column(name="`last_redemption_date`", insertable=false, updatable=false, length=10)
    ...
    @Column(name="`status`", insertable=false, updatable=false, length=10)
    ...
    @Column(name="`Label`", insertable=false, updatable=false, length=4)
    ...
    @Column(name="`property_pin`", insertable=false, updatable=false)
    ...
    @Column(name="`dead`", insertable=false, updatable=false)
    ...
    @Column(name="`address_line1`", insertable=false, updatable=false, length=220)
    ...
    @Column(name="`address_line2`", insertable=false, updatable=false, length=220)
    ...
    @Column(name="`address_city`", insertable=false, updatable=false, length=220)
    ...
    @Column(name="`address_zip`", insertable=false, updatable=false, length=10)
    ...
    @Column(name="`latitude`", insertable=false, updatable=false, precision=9, scale=6)
    ...
    @Column(name="`longitude`", insertable=false, updatable=false, precision=9, scale=6)
    ...
    @Column(name="`property_type`", insertable=false, updatable=false, length=50)
    ...
    @Column(name="`property_exterior_id`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`property_exterior`", insertable=false, updatable=false)
    ...
    @Column(name="`year_built`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`year_improved`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`lot_size`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`sqft_living`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`sqft_total`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`lookup`", insertable=false, updatable=false, length=10)
    ...
    @Column(name="`grade`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`building_count`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`area_count_published`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`area_count_forfeited`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`area_count_auctioned`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`area_count_redeemed`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`ass_tax_year`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`market_value`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`home_exemption`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`senior_exemption`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`double_exemption`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`equalized_valuation`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`senior_freeze`", insertable=false, updatable=false)
    ...
    @Column(name="`property_class_id`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`zoning_improvement`", insertable=false, updatable=false, length=235)
    ...
    @Column(name="`filter`", insertable=false, updatable=false, length=1)
