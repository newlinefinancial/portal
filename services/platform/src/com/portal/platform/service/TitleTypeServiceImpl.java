...
public class TitleTypeServiceImpl implements TitleTypeService {
	...
	@Override
	public TitleType getById(Integer titletypeId) throws EntityNotFoundException {
        LOGGER.debug("Finding TitleType by id: {}", titletypeId);
        TitleType titletype = this.wmGenericDao.findById(titletypeId);
        if (titletype == null){
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<TitleType> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all TitleTypes");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table TitleType to {} format", exportType);
