...
public class PartyServiceImpl implements PartyService {
	...
	@Override
	public Party getById(Integer partyId) throws EntityNotFoundException {
        LOGGER.debug("Finding Party by id: {}", partyId);
        Party party = this.wmGenericDao.findById(partyId);
        if (party == null){
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table Party to {} format", exportType);
