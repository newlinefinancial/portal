...
public class AccountingServiceImpl implements AccountingService {
	...
	@Override
	public Accounting getById(AccountingId accountingId) throws EntityNotFoundException {
        LOGGER.debug("Finding Accounting by id: {}", accountingId);
        Accounting accounting = this.wmGenericDao.findById(accountingId);
        if (accounting == null){
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<Accounting> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all Accountings");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table Accounting to {} format", exportType);
