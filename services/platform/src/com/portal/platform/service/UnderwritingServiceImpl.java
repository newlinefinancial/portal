...
public class UnderwritingServiceImpl implements UnderwritingService {
	...
	@Override
	public Underwriting getById(Integer underwritingId) throws EntityNotFoundException {
        LOGGER.debug("Finding Underwriting by id: {}", underwritingId);
        Underwriting underwriting = this.wmGenericDao.findById(underwritingId);
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<Underwriting> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all Underwritings");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table Underwriting to {} format", exportType);
