...
public class InspectionRouteServiceImpl implements InspectionRouteService {
	...
	@Override
	public InspectionRoute getById(Integer inspectionrouteId) throws EntityNotFoundException {
        LOGGER.debug("Finding InspectionRoute by id: {}", inspectionrouteId);
        InspectionRoute inspectionroute = this.wmGenericDao.findById(inspectionrouteId);
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<InspectionRoute> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all InspectionRoutes");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table InspectionRoute to {} format", exportType);
