...
public class PortalMatterFilterServiceImpl implements PortalMatterFilterService {
	...
	@Override
	public PortalMatterFilter getById(PortalMatterFilterId portalmatterfilterId) throws EntityNotFoundException {
        LOGGER.debug("Finding PortalMatterFilter by id: {}", portalmatterfilterId);
        PortalMatterFilter portalmatterfilter = this.wmGenericDao.findById(portalmatterfilterId);
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<PortalMatterFilter> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all PortalMatterFilters");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table PortalMatterFilter to {} format", exportType);
