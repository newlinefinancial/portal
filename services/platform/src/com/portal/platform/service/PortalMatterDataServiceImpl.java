...
public class PortalMatterDataServiceImpl implements PortalMatterDataService {
	...
	@Override
	public PortalMatterData getById(PortalMatterDataId portalmatterdataId) throws EntityNotFoundException {
        LOGGER.debug("Finding PortalMatterData by id: {}", portalmatterdataId);
        PortalMatterData portalmatterdata = this.wmGenericDao.findById(portalmatterdataId);
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<PortalMatterData> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all PortalMatterDatas");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table PortalMatterData to {} format", exportType);
