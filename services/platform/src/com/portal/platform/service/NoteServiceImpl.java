...
public class NoteServiceImpl implements NoteService {
	...
	@Override
	public Note getById(Integer noteId) throws EntityNotFoundException {
        LOGGER.debug("Finding Note by id: {}", noteId);
        Note note = this.wmGenericDao.findById(noteId);
        if (note == null){
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table Note to {} format", exportType);
