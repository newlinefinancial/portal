...
public class InterestTypeServiceImpl implements InterestTypeService {
	...
	@Override
	public InterestType getById(String interesttypeId) throws EntityNotFoundException {
        LOGGER.debug("Finding InterestType by id: {}", interesttypeId);
        InterestType interesttype = this.wmGenericDao.findById(interesttypeId);
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<InterestType> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all InterestTypes");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table InterestType to {} format", exportType);
