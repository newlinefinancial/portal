...
public class TitleTransactionServiceImpl implements TitleTransactionService {
	...
	@Override
	public TitleTransaction getById(Integer titletransactionId) throws EntityNotFoundException {
        LOGGER.debug("Finding TitleTransaction by id: {}", titletransactionId);
        TitleTransaction titletransaction = this.wmGenericDao.findById(titletransactionId);
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<TitleTransaction> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all TitleTransactions");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table TitleTransaction to {} format", exportType);
