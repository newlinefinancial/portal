...
public class AuctionServiceImpl implements AuctionService {
	...
	@Override
	public Auction getById(Integer auctionId) throws EntityNotFoundException {
        LOGGER.debug("Finding Auction by id: {}", auctionId);
        Auction auction = this.wmGenericDao.findById(auctionId);
        if (auction == null){
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<Auction> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all Auctions");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table Auction to {} format", exportType);
