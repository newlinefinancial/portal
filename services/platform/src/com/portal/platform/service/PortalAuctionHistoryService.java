...
public interface PortalAuctionHistoryService {
	 ...
	 *
	 * @param portalAuctionHistoryId The id of the wanted PortalAuctionHistory.
	 * @return The found PortalAuctionHistory. If no PortalAuctionHistory is found, this method returns null.
	 */
	PortalAuctionHistory getById(PortalAuctionHistoryId portalAuctionHistoryId) throws EntityNotFoundException;

	/**
	 * Finds all PortalAuctionHistories.
	 *
	 * @return A list of PortalAuctionHistories.
	 */
    @Deprecated
    ...
    Page<PortalAuctionHistory> findAssociatedValues(Object value, String entityName, String key,  Pageable pageable);
