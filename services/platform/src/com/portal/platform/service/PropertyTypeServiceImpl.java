...
public class PropertyTypeServiceImpl implements PropertyTypeService {
	...
	@Override
	public PropertyType getById(Integer propertytypeId) throws EntityNotFoundException {
        LOGGER.debug("Finding PropertyType by id: {}", propertytypeId);
        PropertyType propertytype = this.wmGenericDao.findById(propertytypeId);
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<PropertyType> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all PropertyTypes");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table PropertyType to {} format", exportType);
