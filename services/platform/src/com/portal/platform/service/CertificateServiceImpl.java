...
public class CertificateServiceImpl implements CertificateService {
	...
	@Override
	public Certificate getById(Integer certificateId) throws EntityNotFoundException {
        LOGGER.debug("Finding Certificate by id: {}", certificateId);
        Certificate certificate = this.wmGenericDao.findById(certificateId);
        if (certificate == null){
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<Certificate> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all Certificates");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table Certificate to {} format", exportType);
