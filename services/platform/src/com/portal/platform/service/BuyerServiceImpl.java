...
public class BuyerServiceImpl implements BuyerService {
	...
	@Override
	public Buyer getById(Integer buyerId) throws EntityNotFoundException {
        LOGGER.debug("Finding Buyer by id: {}", buyerId);
        Buyer buyer = this.wmGenericDao.findById(buyerId);
        if (buyer == null){
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<Buyer> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all Buyers");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table Buyer to {} format", exportType);
