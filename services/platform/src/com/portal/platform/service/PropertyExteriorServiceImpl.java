...
public class PropertyExteriorServiceImpl implements PropertyExteriorService {
	...
	@Override
	public PropertyExterior getById(Integer propertyexteriorId) throws EntityNotFoundException {
        LOGGER.debug("Finding PropertyExterior by id: {}", propertyexteriorId);
        PropertyExterior propertyexterior = this.wmGenericDao.findById(propertyexteriorId);
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<PropertyExterior> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all PropertyExteriors");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table PropertyExterior to {} format", exportType);
