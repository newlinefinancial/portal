...
public class MatterServiceImpl implements MatterService {
	...
	@Override
	public Matter getById(Integer matterId) throws EntityNotFoundException {
        LOGGER.debug("Finding Matter by id: {}", matterId);
        Matter matter = this.wmGenericDao.findById(matterId);
        if (matter == null){
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<Matter> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all Matters");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table Matter to {} format", exportType);
