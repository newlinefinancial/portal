...
public class GradeServiceImpl implements GradeService {
	...
	@Override
	public Grade getById(Integer gradeInstanceId) throws EntityNotFoundException {
        LOGGER.debug("Finding Grade by id: {}", gradeInstanceId);
        Grade gradeInstance = this.wmGenericDao.findById(gradeInstanceId);
        if (gradeInstance == null){
            LOGGER.debug("No Grade found with id: {}", gradeInstanceId);
            throw new EntityNotFoundException(String.valueOf(gradeInstanceId));
        }
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<Grade> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all Grades");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table Grade to {} format", exportType);
