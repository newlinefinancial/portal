...
public class PortalAuctionTitleServiceImpl implements PortalAuctionTitleService {
	...
	@Override
	public PortalAuctionTitle getById(PortalAuctionTitleId portalauctiontitleId) throws EntityNotFoundException {
        LOGGER.debug("Finding PortalAuctionTitle by id: {}", portalauctiontitleId);
        PortalAuctionTitle portalauctiontitle = this.wmGenericDao.findById(portalauctiontitleId);
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<PortalAuctionTitle> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all PortalAuctionTitles");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table PortalAuctionTitle to {} format", exportType);
