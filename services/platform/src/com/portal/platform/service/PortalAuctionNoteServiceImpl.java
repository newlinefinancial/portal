...
public class PortalAuctionNoteServiceImpl implements PortalAuctionNoteService {
	...
	@Override
	public PortalAuctionNote getById(PortalAuctionNoteId portalauctionnoteId) throws EntityNotFoundException {
        LOGGER.debug("Finding PortalAuctionNote by id: {}", portalauctionnoteId);
        PortalAuctionNote portalauctionnote = this.wmGenericDao.findById(portalauctionnoteId);
    ...
    @Transactional(readOnly = true, value = "platformTransactionManager")
    @Override
    public Page<PortalAuctionNote> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all PortalAuctionNotes");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service platform for table PortalAuctionNote to {} format", exportType);
