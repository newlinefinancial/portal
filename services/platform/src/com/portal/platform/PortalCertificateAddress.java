...
/**
 * PortalCertificateAddress generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`portal_certificate_address`", schema = "review")
@IdClass(PortalCertificateAddressId.class)
public class PortalCertificateAddress implements Serializable {
    ...
    @Id
    @Column(name = "`zoning`", nullable = true, length = 12)
    ...
    @Id
    @Column(name = "`improvement_level`", nullable = true, length = 220)
