...
/**
 * PortalCertificateAddress generated by hbm2java
 */
@Entity
@Table(name="`portal_certificate_address`"
    ,schema="review"
)
@IdClass(value=PortalCertificateAddressId.class)
public class PortalCertificateAddress  implements java.io.Serializable {
    ...
    public PortalCertificateAddress() {
    }
    ...
    @Column(name="`address_verified`", insertable=false, updatable=false)
    ...
    @Column(name="`zoning`", insertable=false, updatable=false, length=12)
    ...
    @Column(name="`improvement_level`", insertable=false, updatable=false, length=220)
    ...
    public boolean equals(Object o) {
		 ...
		 if ( !(o instanceof PortalCertificateAddress) )
		    return false;

		 PortalCertificateAddress that = (PortalCertificateAddress) o;
