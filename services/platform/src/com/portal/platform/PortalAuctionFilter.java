...
/**
 * PortalAuctionFilter generated by hbm2java
 */
@Entity
@Table(name="`portal_auction_filter`"
    ,schema="review"
)
@IdClass(value=PortalAuctionFilterId.class)
public class PortalAuctionFilter  implements java.io.Serializable {
    ...
    @Column(name="`area_rating`", insertable=false, updatable=false, length=1)
    ...
    @Column(name="`auction_day`", insertable=false, updatable=false, precision=10)
    ...
    @Column(name="`buyer_type`", insertable=false, updatable=false, length=1)
    ...
    @Column(name="`tags`", insertable=false, updatable=false, length=125)
    ...
    public boolean equals(Object o) {
		 ...
		 if ( !(o instanceof PortalAuctionFilter) )
		    return false;

		 PortalAuctionFilter that = (PortalAuctionFilter) o;
