...
/**
 * BidSequence generated by hbm2java
 */
@Entity
@Table(name="`bid_sequence`"
    ,schema="review"
)
@IdClass(value=BidSequenceId.class)
public class BidSequence  implements java.io.Serializable {
    ...
    @Column(name="`order`", insertable=false, updatable=false, precision=20)
    ...
    public boolean equals(Object o) {
		 ...
		 if ( !(o instanceof BidSequence) )
		    return false;

		 BidSequence that = (BidSequence) o;
