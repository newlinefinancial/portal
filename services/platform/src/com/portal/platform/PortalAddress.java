...
/**
 * PortalAddress generated by hbm2java
 */
@Entity
@Table(name="`portal_address`"
    ,schema="review"
)
@IdClass(value=PortalAddressId.class)
public class PortalAddress  implements java.io.Serializable {
    ...
    public boolean equals(Object o) {
		 ...
		 if ( !(o instanceof PortalAddress) )
		    return false;

		 PortalAddress that = (PortalAddress) o;
