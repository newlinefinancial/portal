...
/**
 * PortalGradeNote generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`portal_grade_note`", schema = "review")
@IdClass(PortalGradeNoteId.class)
public class PortalGradeNote implements Serializable {
